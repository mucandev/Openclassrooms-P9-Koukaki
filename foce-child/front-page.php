    ...
    <main id="primary" class="site-main">
        <section class="banner">
            ...
            <video class="background-video" autoplay loop muted>
                <source src="<?php echo get_stylesheet_directory_uri() . '/assets/video/Koukaki-video-header.mp4'; ?>" poster=<?php echo get_template_directory_uri() . '/assets/images/banner.png'; ?>  type="video/mp4" >
            </video>
        </section>
